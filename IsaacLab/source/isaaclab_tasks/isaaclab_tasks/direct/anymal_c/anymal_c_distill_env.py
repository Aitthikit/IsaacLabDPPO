...
class AnymalCDistillEnv(DirectRLEnv):
    ...
    def _reset_idx(self, env_ids: torch.Tensor | None):
        ...
        # Sample new commands
        self._commands[env_ids,:3] = torch.zeros_like(self._commands[env_ids,:3]).uniform_(-1.0, 1.0)
        self._commands[env_ids,3] = torch.zeros_like(self._commands[env_ids,3]).uniform_(-1.5, 1.5)
        # Reset robot state
