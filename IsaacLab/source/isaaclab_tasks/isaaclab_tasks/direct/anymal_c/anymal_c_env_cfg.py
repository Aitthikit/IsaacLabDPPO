...
class AnymalCDistillEnvCfg(DirectRLEnvCfg):
    ...
    # locomotion_model = "logs/rsl_rl/Anymal_locomotion_risk_fix/Anymal_locomotion/exported/policy.pt"
    # encoder_model = "logs/rsl_rl/Anymal_locomotion_risk_fix/Anymal_locomotion/exported/encoder.pt"
    encoderbase_model = "logs/rsl_rl/Anymal_locomotion_risk_fix/Anymal_locomotion/model_4999.pt"
